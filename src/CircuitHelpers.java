...
{
	private static void fillCombinations(ArrayList<Boolean> current,
			ArrayList<ArrayList<Boolean>> result, int n)
	{
		// base case
		if (current.size() == n)
		{
	 ...
	 * 
	 * @param n
	 *            the length of the binary combination(number)
	 * @return Arraylist of arraylists of boolean, each one representing a
	 *         combination
	 */
	 ...
	 * 
	 * @param flipflops
	 *            Arraylist of flipflops whose currentState will be assigned
	 * @param combination
	 *            ArrayList of boolean to be the flipflops currentState
	 */
	public static void mapFlipFlopsCurrentStates(ArrayList<FlipFlop> flipflops,
	...
	/**
	 * Converts the binary number formed by the flipflops currentState to
	 * decimal
	 * 
	 * @param fliplflops
	 *            ArrayList of the circuit's flipflops
	 * @return an integer which equals the binary combination of the flipflops
	 *         currentStates
	 */
	...
	/**
	 * @param boolArr
	 *            list of 0s and 1s representing a binary number with the least
	 ...
	 * 
	 * @param inputs
	 *            the input whose values willbe assigned
	 * @param combination
	 *            an ArrayList of boolean values which will be assigned to
	 *            theinputs
	 */
	 ...
	 * @param n
	 *            the number of bits of the output binary
